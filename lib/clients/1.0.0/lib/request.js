...
/*
  depthQuery(market, limit, interval) {
    const packet = {
      method: 'depth.query',
      params: [market, limit, interval]
    }
...
*/
  /*
  authRegister(address, expired) {
    const packet = {
      method: 'auth.register',
      params: [address, expired],
      id: this._id++
    }
...
/*
    setTimeout(() => {
      this.authRegister('Wkr1HQ1Y2WpigkwK7YcKq2rrhDndJLvCQV', Math.round(Date.now()/1000+60*60));
    }, 5000);*/
